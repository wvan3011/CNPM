...
$base_url = 'https://muarefb.com/'; // Thay url web bạn
...
class CMSNT
{
    ...
    function connect()
    {
        if (!$this->ketnoi)
        {
            $this->ketnoi = mysqli_connect('localhost', 'tmuarefbtk_wvan3011', 'Vv30112000', 'tmuarefbtk_shopclone5') or die ('Vui lòng kết nối đến DATABASE');
