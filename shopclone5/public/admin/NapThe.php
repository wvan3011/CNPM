                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">API Nạp Thẻ [<a href="https://card24h.com/api/"
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Chiết khấu nạp thẻ</label>
                                <div class="col-sm-8">
                                    <div class="form-line">
                                        <input type="text" name="ck_card" value="<?=$CMSNT->site('ck_card');?>"
                                            class="form-control">
                                    </div>
                                    <i>VD: ck = 10 khi khách nạp 100.000đ thực nhận của khách sẽ còn 90.000đ</i>
                                </div>
                            </div>
                            <div class="form-group row">
